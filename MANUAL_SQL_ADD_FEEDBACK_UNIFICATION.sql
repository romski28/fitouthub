...
ALTER TABLE "Project"
  ADD COLUMN IF NOT EXISTS "clientFeedbackSubmitted" BOOLEAN NOT NULL DEFAULT false,
  ADD COLUMN IF NOT EXISTS "proFeedbackSubmitted" BOOLEAN NOT NULL DEFAULT false;
