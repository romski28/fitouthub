...
const nextStepSeeds: NextStepSeed[] = [
  ...
  { projectStage: ProjectStage.PRE_WORK, role: 'CLIENT', actionKey: 'START_PROJECT_ON_SITE', actionLabel: 'Start project on site', description: 'Escrow is funded. Be on site when the professional arrives to confirm the start.', isPrimary: true, requiresAction: true, displayOrder: 3 },
  ...
  { projectStage: ProjectStage.PRE_WORK, role: 'PROFESSIONAL', actionKey: 'VIEW_QUOTE', actionLabel: 'View your quote', description: 'Review your accepted quote details. To change the start date, use the Schedule tab. To add out-of-scope work, use Request additional works payment.', isPrimary: false, isElective: true, requiresAction: false, displayOrder: 2 },
  { projectStage: ProjectStage.PRE_WORK, role: 'PROFESSIONAL', actionKey: 'MAKE_MILESTONE_1_CLAIM', actionLabel: 'Submit materials claim', description: 'Submit purchase receipts and claimed amount for milestone 1 materials. The client will review and approve the confirmed amount to your withdrawable wallet.', isPrimary: false, isElective: true, requiresAction: true, displayOrder: 3 },
