...
export class NextStepService {
  ...
  async getNextSteps(
    ...
    // Block preserved as dead code for reference; gated with if(false) for TS strict mode.
    if (false) {
      void (effectiveStage as any); void (project as any); void (nextSteps as any); void (isProfessional as any);
