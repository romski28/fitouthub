...
BEGIN
  ...
  VALUES
    ...
    ('qqr_pain_points', survey_questionnaire_id, 'pain_points', 'How significant are the following business pain points for you?', 'Rate each 1 (not a problem) to 5 (major problem).', 'matrix_rating', NULL, NULL,
      '{"rows":[{"key":"unpredictable_lead_flow","label":"Unpredictable lead flow","labelZhHk":"工作來源不穩定"},{"key":"customers_who_ghost","label":"Customers who ghost","labelZhHk":"報價後客戶「消失」"},{"key":"late_disputed_payment","label":"Late / disputed payment","labelZhHk":"付款延遲或糾紛"},{"key":"scope_creep","label":"Scope creep","labelZhHk":"客戶不斷加工但不加錢"},{"key":"quoting_waste","label":"Quoting waste","labelZhHk":"浪費時間報價但工程告吹"},{"key":"race_to_bottom_on_price","label":"Race to bottom on price","labelZhHk":"被低質素競爭者壓低價格"},{"key":"building_online_reputation","label":"Building online reputation","labelZhHk":"難以建立網上口碑"},{"key":"cash_flow_issues","label":"Cash flow issues","labelZhHk":"工程之間的現金流問題"}]}'::jsonb,
      TRUE, 8),
    ...
    ('qqr_feature_importance', survey_questionnaire_id, 'feature_importance', 'How important are the following platform features to you?', 'Rate each 1 (not important) to 5 (essential).', 'matrix_rating', NULL, NULL,
      '{"rows":[{"key":"escrow_payment","label":"Escrow payment","labelZhHk":"代管付款保障"},{"key":"reviews_verified_history","label":"Reviews + verified history","labelZhHk":"顯示評價及經核實工程紀錄"},{"key":"standardised_quote_template","label":"Standardised quote template","labelZhHk":"標準工程說明／報價範本"},{"key":"job_tracking","label":"Job tracking","labelZhHk":"應用程式內工程追蹤"},{"key":"materials_discounts","label":"Materials discounts","labelZhHk":"以優惠價獲取建築材料"},{"key":"dispute_resolution","label":"Dispute resolution","labelZhHk":"獨立仲裁糾紛解決"},{"key":"trade_matched_leads","label":"Trade-matched leads","labelZhHk":"按你的工種配對工程"}]}'::jsonb,
      TRUE, 12),
