...
const WHATSAPP_NUMBER = '+442079460000';
...
const channels = [
  {
    ...
    methods: [
      {
        label: 'Email',
        value: 'support@fitouthub.com',
        href: 'mailto:support@fitouthub.com',
  ...
  },
  {
    ...
    methods: [
      {
        label: 'Email',
        value: 'tech@fitouthub.com',
        href: 'mailto:tech@fitouthub.com',
        icon: '/assets/images/email.svg',
      },
      {
        label: 'WhatsApp',
  ...
  },
  {
    ...
    methods: [
      {
        label: 'Email',
        value: 'partners@fitouthub.com',
        href: 'mailto:partners@fitouthub.com',
        icon: '/assets/images/email.svg',
      },
      {
        label: 'WhatsApp',
    ...
    <div className="mx-auto max-w-5xl px-6 py-12 space-y-10">
      <header className="space-y-3 text-center">
        ...
        <p className="text-slate-600 max-w-2xl mx-auto">
          Send us a WhatsApp message and one of our team will respond, or fill in the callback form below and we will get
          back to you.
        </p>
      </header>
      ...
      <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
        {channels.map((channel) => (
          <div
            key={channel.team}
            className="rounded-xl border border-slate-200 bg-white/90 shadow-sm backdrop-blur-sm p-5 flex flex-col gap-4"
          >
