    ...
    <div className="min-h-screen bg-[#F5EEDE]">
      <header className="border-b border-[#D4C8A0] bg-white/60 backdrop-blur-sm">
        <div className="mx-auto flex max-w-4xl items-center justify-between px-6 py-4">
          <div className="flex items-center gap-3">
            ...
            <h1 className="text-xl font-bold text-slate-900">Estate Agent Dashboard</h1>
          </div>
          <Link
            href="/projects"
      ...
      <main className="mx-auto max-w-4xl px-6 py-16">
        <div className="rounded-3xl border border-[rgba(120,53,15,0.14)] bg-[rgba(255,250,240,0.84)] p-10 text-center shadow-[0_18px_40px_rgba(81,55,32,0.05)] backdrop-blur-sm">
          ...
          <h2 className="text-2xl font-bold text-slate-900 mb-3">Your estate agent tools are coming soon</h2>
          <p className="text-slate-600 max-w-md mx-auto leading-relaxed">
            We're building a dedicated space for estate agents — create renovation project briefs
            for properties you're selling, connect clients with vetted contractors, and add value
            to every transaction.
          </p>

          {isLoggedIn && user && (
            <div className="mt-8 inline-block rounded-xl border border-teal-200 bg-teal-50 px-6 py-3 text-left">
