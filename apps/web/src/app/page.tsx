  ...
  return (
    <div className="relative isolate">
      ...
      <div className="space-y-12 pb-8">
        ...
        <section
          id="project-prompt"
          className="relative -mx-6 -mt-6 rounded-b-3xl border-b border-white/45 bg-white/62 px-6 py-12 backdrop-blur-sm"
        >
          <div className="mx-auto grid max-w-6xl grid-cols-1 gap-8 lg:grid-cols-2 lg:items-start">
            ...
            <div className="order-1 rounded-2xl border border-slate-200/80 bg-white/88 p-4 shadow-sm lg:order-1 lg:mt-2">
        ...
        {/* Hero Section */}
        <section className="relative overflow-hidden rounded-2xl border border-white/50 bg-white/64 backdrop-blur-sm">
          <div
          ...
          <div className="relative p-8 lg:p-12">
            <div
              className="max-w-2xl rounded-xl bg-white/72 p-4 space-y-4 text-slate-800 sm:p-5"
