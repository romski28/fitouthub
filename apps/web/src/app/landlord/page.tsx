    ...
    <div className="min-h-screen bg-[#F5EEDE]">
      ...
      <header className="border-b border-[#D4C8A0] bg-white/60 backdrop-blur-sm">
        <div className="mx-auto flex max-w-4xl items-center justify-between px-6 py-4">
          <div className="flex items-center gap-3">
            ...
            <h1 className="text-xl font-bold text-slate-900">Landlord Dashboard</h1>
          </div>
          <Link
            href="/projects"
      ...
      <main className="mx-auto max-w-4xl px-6 py-16">
        <div className="rounded-3xl border border-[rgba(120,53,15,0.14)] bg-[rgba(255,250,240,0.84)] p-10 text-center shadow-[0_18px_40px_rgba(81,55,32,0.05)] backdrop-blur-sm">
          ...
          <h2 className="text-2xl font-bold text-slate-900 mb-3">Your landlord tools are coming soon</h2>
          <p className="text-slate-600 max-w-md mx-auto leading-relaxed">
            We&apos;re building a dedicated space where you can manage renovation projects across your
            property portfolio — request quotes, track progress, and coordinate with tenants and
            contractors, all in one place.
          </p>

          {isLoggedIn && user && (
            <div className="mt-8 inline-block rounded-xl border border-emerald-200 bg-emerald-50 px-6 py-3 text-left">
