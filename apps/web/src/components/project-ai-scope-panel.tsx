  ...
  return (
    <div className="rounded-xl border border-slate-200 bg-white p-4 shadow-sm space-y-4">
      <div className="flex flex-wrap items-center justify-between gap-2">
        <div>
          <h3 className="text-base font-bold text-slate-900">AI Scope of Works</h3>
          <p className="text-xs text-slate-500">PM-style draft scope and programme. Version count: {versionCount}</p>
        </div>
        <button
          type="button"
      ...
      {!loading && !scope && (
        <p className="text-sm text-slate-600">No scope generated yet. Add context and generate the first draft.</p>
      )}
