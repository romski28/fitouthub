...
export default function CornerRibbon() {
  ...
  return (
    <div className="fixed top-0 right-0 z-50 w-32 h-32 overflow-hidden pointer-events-none">
      <div className="absolute top-0 right-0 w-48 h-48 bg-gradient-to-bl from-emerald-500 via-emerald-600 to-emerald-700 transform rotate-45 -translate-y-24 translate-x-24 flex items-center justify-center pointer-events-auto">
        <button
