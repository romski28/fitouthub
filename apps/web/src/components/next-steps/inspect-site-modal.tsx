...
export function InspectSiteModal({ isOpen, onClose, projectId: projectIdProp, workerMode = false, siteInspectionPhase = null }: InspectSiteModalProps) {
  ...
  useEffect(() => {
    ...
    if (!isOpen || loading || error || !address || hasAutoGenerated || alreadyVisited || siteInspectionPhase === 'booking') return;
    setHasAutoGenerated(true);
    generateQr();
    // eslint-disable-next-line react-hooks/exhaustive-deps
  }, [isOpen, loading, error, address, hasAutoGenerated, status?.requestStatus, siteInspectionPhase]);
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm">
      <div className="w-full max-w-xl rounded-2xl border border-[#D4C8A0] bg-[#F5EEDE] shadow-2xl max-h-[90vh] flex flex-col">
        ...
        <div className="overflow-y-auto flex-1 px-5 py-4 space-y-4">
          ...
          {!loading && !error && address && !showBookingForm && (
            <>
              {/* Date / visited status */}
              {isVisited ? (
